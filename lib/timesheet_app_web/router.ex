defmodule TimesheetAppWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TimesheetAppWeb.Layouts, :root}
  ...
  if Application.compile_env(:timesheet_app, :dev_routes) do
    ...
    scope "/dev" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: TimesheetAppWeb.Telemetry
